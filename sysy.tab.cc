...
static const yytype_int16 yyrline[] =
{
      ...
      84,    92,    97,   106,   112,   118,   127,   130,   136,   140,
     147,   150,   157,   160,   163,   169,   174,   179,   184,   192,
     195,   201,   204,   209,   213,   220,   223,   226,   229,   235,
     238,   244,   247,   250,   253,   256,   259,   262,   265,   268,
     271,   274,   280,   286,   292,   296,   303,   306,   309,   315,
     321,   330,   333,   337,   341,   345,   351,   355,   362,   365,
     371,   374,   378,   382,   389,   392,   396,   403,   406,   410,
     414,   418,   424,   427,   431,   438,   441,   448,   451
};
#endif
...
#line 1704 "sysy.tab.cc"
    break;

  case 10: /* ConstDecl: ConstDecl COMMA ConstDef  */
#line 84 "./parser/sysy.yy"
                               {
...
#line 1753 "sysy.tab.cc"
    break;

  case 15: /* VarDecl: VarDecl COMMA VarDef  */
#line 118 "./parser/sysy.yy"
                           {
...
#line 2089 "sysy.tab.cc"
    break;

  case 55: /* LVal: LVal LB Exp RB  */
#line 296 "./parser/sysy.yy"
                     {
        (yyval.ptr)=mknode(LVal,(yyvsp[-3].ptr),(yyvsp[-1].ptr),NULL,yylineno);
        strcpy((yyval.ptr)->type_id,(yyvsp[-3].ptr)->type_id);
    }
#line 2098 "sysy.tab.cc"
    break;

  case 56: /* PrimaryExp: LP Exp RP  */
#line 303 "./parser/sysy.yy"
                      {
    (yyval.ptr)=(yyvsp[-1].ptr);
}
#line 2106 "sysy.tab.cc"
    break;

  case 57: /* PrimaryExp: LVal  */
#line 306 "./parser/sysy.yy"
           {
        (yyval.ptr)=(yyvsp[0].ptr);
    }
#line 2114 "sysy.tab.cc"
    break;

  case 58: /* PrimaryExp: Number  */
#line 309 "./parser/sysy.yy"
             {
        (yyval.ptr)=(yyvsp[0].ptr);
    }
#line 2122 "sysy.tab.cc"
    break;

  case 59: /* Number: INTCONST  */
#line 315 "./parser/sysy.yy"
                 {
...
#line 2133 "sysy.tab.cc"
    break;

  case 60: /* Number: FLOATCONST  */
#line 321 "./parser/sysy.yy"
                 {
        (yyval.ptr)=mknode(Number,NULL,NULL,NULL,yylineno);
...
#line 2144 "sysy.tab.cc"
    break;

  case 61: /* UnaryExp: PrimaryExp  */
#line 330 "./parser/sysy.yy"
                     {
    (yyval.ptr)=(yyvsp[0].ptr);
}
#line 2152 "sysy.tab.cc"
    break;

  case 62: /* UnaryExp: ADD UnaryExp  */
#line 333 "./parser/sysy.yy"
                   {
...
#line 337 "./parser/sysy.yy"
                   {
        (yyval.ptr)=mknode(UnaryExp,(yyvsp[0].ptr),NULL,NULL,yylineno);
        strcpy((yyval.ptr)->op,"-");
    }
#line 2170 "sysy.tab.cc"
    break;

  case 64: /* UnaryExp: NOT UnaryExp  */
#line 341 "./parser/sysy.yy"
                   {
        (yyval.ptr)=mknode(UnaryExp,(yyvsp[0].ptr),NULL,NULL,yylineno);
        strcpy((yyval.ptr)->op,"!");
    }
#line 2179 "sysy.tab.cc"
    break;
...
#line 2308 "sysy.tab.cc"
    break;

  case 80: /* RelExp: RelExp LE AddExp  */
#line 414 "./parser/sysy.yy"
                       {
        (yyval.ptr)=mknode(RelExp,(yyvsp[-2].ptr),(yyvsp[0].ptr),NULL,yylineno);
        strcpy((yyval.ptr)->op,"<=");
    }
#line 2317 "sysy.tab.cc"
    break;

  case 81: /* RelExp: RelExp GE AddExp  */
#line 418 "./parser/sysy.yy"
                       {
        (yyval.ptr)=mknode(RelExp,(yyvsp[-2].ptr),(yyvsp[0].ptr),NULL,yylineno);
        strcpy((yyval.ptr)->op,">=");
    }
#line 2326 "sysy.tab.cc"
    break;

  case 82: /* EqExp: RelExp  */
#line 424 "./parser/sysy.yy"
              {
    (yyval.ptr)=(yyvsp[0].ptr);
}
#line 2334 "sysy.tab.cc"
    break;

  case 83: /* EqExp: EqExp EQ RelExp  */
#line 427 "./parser/sysy.yy"
                      {
        (yyval.ptr)=mknode(EqExp,(yyvsp[-2].ptr),(yyvsp[0].ptr),NULL,yylineno);
        strcpy((yyval.ptr)->op,"==");
    }
#line 2343 "sysy.tab.cc"
    break;
