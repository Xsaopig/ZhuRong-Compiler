...
static const yytype_int16 yyrline[] =
{
      ...
      85,    94,   100,   109,   114,   123,   130,   133,   139,   144,
     165,   168,   175,   178,   181,   188,   193,   199,   204,   212,
     216,   223,   228,   241,   246,   256,   259,   262,   265,   271,
     274,   281,   284,   287,   290,   293,   296,   299,   302,   305,
     308,   311,   317,   323,   329,   333,   340,   343,   346,   352,
     358,   367,   370,   374,   378,   382,   388,   392,   399,   402,
     408,   411,   415,   419,   426,   429,   433,   440,   443,   447,
     451,   455,   461,   464,   468,   475,   478,   485,   488
};
#endif
...
#line 1748 "sysy.tab.cc"
    break;

  case 14: /* BType: FLOAT  */
#line 114 "./parser/sysy.yy"
            {
        (yyval.ptr)=mknode(BType,NULL,NULL,NULL,yylineno);
...
#line 1793 "sysy.tab.cc"
    break;

  case 19: /* Idents: Idents LB Exp RB  */
#line 144 "./parser/sysy.yy"
                       {
...
#line 1898 "sysy.tab.cc"
    break;

  case 29: /* FuncFParams: FuncFParam  */
#line 212 "./parser/sysy.yy"
                        {
...
#line 1942 "sysy.tab.cc"
    break;

  case 33: /* FuncFParam: BType IDENT  */
#line 241 "./parser/sysy.yy"
                        {
...
#line 308 "./parser/sysy.yy"
                  {
        (yyval.ptr)=mknode(RETURN,NULL,NULL,NULL,yylineno);
    }
#line 2093 "sysy.tab.cc"
    break;

  case 51: /* Stmt: RETURN Exp SEMI  */
#line 311 "./parser/sysy.yy"
                      {
        (yyval.ptr)=mknode(RETURN,(yyvsp[-1].ptr),NULL,NULL,yylineno);
    }
#line 2101 "sysy.tab.cc"
    break;

  case 52: /* Exp: AddExp  */
#line 317 "./parser/sysy.yy"
            {
    (yyval.ptr)=(yyvsp[0].ptr);
}
#line 2109 "sysy.tab.cc"
    break;

  case 53: /* Cond: LOrExp  */
#line 323 "./parser/sysy.yy"
             {
    (yyval.ptr)=(yyvsp[0].ptr);
}
#line 2117 "sysy.tab.cc"
    break;

  case 54: /* LVal: IDENT  */
#line 329 "./parser/sysy.yy"
            {
    (yyval.ptr)=mknode(LVal,NULL,NULL,NULL,yylineno);
    strcpy((yyval.ptr)->type_id,(yyvsp[0].type_id));
}
#line 2126 "sysy.tab.cc"
    break;
...
#line 2135 "sysy.tab.cc"
    break;

  case 56: /* PrimaryExp: LP Exp RP  */
#line 340 "./parser/sysy.yy"
                      {
    (yyval.ptr)=(yyvsp[-1].ptr);
}
#line 2143 "sysy.tab.cc"
    break;

  case 57: /* PrimaryExp: LVal  */
#line 343 "./parser/sysy.yy"
           {
        (yyval.ptr)=(yyvsp[0].ptr);
    }
#line 2151 "sysy.tab.cc"
    break;

  case 58: /* PrimaryExp: Number  */
#line 346 "./parser/sysy.yy"
             {
        (yyval.ptr)=(yyvsp[0].ptr);
    }
#line 2159 "sysy.tab.cc"
    break;

  case 59: /* Number: INTCONST  */
#line 352 "./parser/sysy.yy"
                 {
